...
export const Calendar = memo(
	({ value, onChange, isStartDateActive = false, isEndDateActive = true }) => {
		...
		const handleDayClick = useCallback(
			...
			[onChange, value, isStartDateActive, isEndDateActive],
		)
		...
		return (
			<div className={classes.calendar}>
				...
				<div className={classes.calendarBlock}>
					<div className={classes.calendarDayNames}>
					...
					<div className={classes.calendarGridDays}>
						{daysList.map((d, i) => {
